...
//        Crashlytics.logException(BaseRuntimeException("CameraView finish $message"))
    ...
    private fun openCamera() {
        ...
        try {
            ...
            configMap.highSpeedVideoFpsRanges
...
//                set(CaptureRequest.CONTROL_AE_EXPOSURE_COMPENSATION, currentExposureLevel)
//                set(CaptureRequest.CONTROL_MODE, CaptureRequest.CONTROL_MODE_AUTO)
    ...
    private fun buildVideoRecordCaptureRequest(cameraDevice: CameraDevice, mediaRecorder: MediaRecorder) =
            cameraDevice.createCaptureRequest(CameraDevice.TEMPLATE_RECORD).apply {
                ...
                set(
                    CaptureRequest.CONTROL_SCENE_MODE,
                    CaptureRequest.REQUEST_AVAILABLE_CAPABILITIES_CONSTRAINED_HIGH_SPEED_VIDEO
                )
                set(
                    CaptureRequest.CONTROL_AE_TARGET_FPS_RANGE,
                    Range(60, 60)
